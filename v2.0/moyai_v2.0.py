...
async def on_message(message):
    ...
    if message.content.startswith('!ballsdeath'):
            ...
            await asyncio.sleep(0.1)
    if message.content.startswith('how do i fix error 80010017'):
        await message.channel.send(error80010017)
        await asyncio.sleep(0.1)
    if message.content.startswith('how do i fix error 80010007'):
        await message.channel.send(error80010007)
        await asyncio.sleep(0.1)
    if message.content.startswith('how do i fix ps2 blackscreens'):
        await message.channel.send(ps2blackscreen)
        await asyncio.sleep(0.1)
    if message.content.startswith('how do i fix error 80029C7F'):
        await message.channel.send(error80029C7F)
        await asyncio.sleep(0.1)
    if message.content.startswith('how do i fix error 80010009'):
        await message.channel.send(error80010009)
        await asyncio.sleep(0.1)
    if message.content.startswith('were do i download evilnat'):
